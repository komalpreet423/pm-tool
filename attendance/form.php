            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="date" id="date" required autocomplete="off"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="note" id="note" required><?php echo isset($row['note']) ? strip_tags($row['note']) : ''; ?></textarea>
                    </div>
                </div>
